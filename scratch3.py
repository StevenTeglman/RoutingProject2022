...
G = nx.read_gpickle("simulation_logs\\17_14_53_58\graph.gpickle")
start = 2699
end = 2831
...
G = sdto.algorithm(graph=G, start=start, end=end, safety_value_min=2, distance_saved_allowence=10)
